...
const defaultProducts = [
  { id: 'd1111111-1111-4111-a111-111111111111', name: 'منظف ملابس لافندر', description: 'منظف ملابس سائل برائحة اللافندر المنعشة، سعة 3 لتر.', section_id: '11111111-1111-4111-a111-111111111111', primary_image_url: 'https://images.unsplash.com/photo-1610557892470-76d747eed2f3?w=500', base_price: 120, wholesale_price: 95, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd2222222-2222-4222-a222-222222222222', name: 'مسحوق غسيل أوتوماتيك', description: 'مسحوق غسيل عالي الجودة للغسالات الأوتوماتيك، عبوة 5 كيلو.', section_id: '11111111-1111-4111-a111-111111111111', primary_image_url: 'https://images.unsplash.com/photo-1583947581924-860bda6a26df?w=500', base_price: 240, wholesale_price: 190, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd3333333-3333-4333-a333-333333333333', name: 'طقم معالق خشبية', description: 'طقم مكون من 5 ملاعق خشبية مختلفة الأحجام للطبخ والتقديم.', section_id: '22222222-2222-4222-a222-222222222222', primary_image_url: 'https://images.unsplash.com/photo-1594756184511-df7de9d8d648?w=500', base_price: 85, wholesale_price: 65, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd4444444-4444-4444-a444-444444444444', name: 'قطاعة خضروات متعددة الوظائف', description: 'قطاعة خضروات يدوية مع 4 شفرات مختلفة ستانلس ستيل.', section_id: '22222222-2222-4222-a222-222222222222', primary_image_url: 'https://images.unsplash.com/photo-1506368249639-73a05d6f6488?w=500', base_price: 150, wholesale_price: null, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd5555555-5555-4555-a555-555555555555', name: 'مناديل مطبخ رول', description: 'طقم 4 رول مناديل مطبخ عالية الامتصاص ومتينة.', section_id: '33333333-3333-4333-a333-333333333333', primary_image_url: 'https://images.unsplash.com/photo-1584622650111-993a426fbf0a?w=500', base_price: 45, wholesale_price: 35, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd6666666-6666-4666-a666-666666666666', name: 'طقم موزع صابون سيراميك', description: 'طقم موزع صابون وحامل فرشاة أسنان بتصميم عصري من السيراميك.', section_id: '44444444-4444-4444-a444-444444444444', primary_image_url: 'https://images.unsplash.com/photo-1600585154526-990dced4db0d?w=500', base_price: 195, wholesale_price: 150, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd7777777-7777-4777-a777-777777777777', name: 'فستان صيفي مشجر', description: 'فستان صيفي مريح وأنيق بخامات قطنية عالية الجودة.', section_id: '55555555-5555-4555-a555-555555555555', primary_image_url: 'https://images.unsplash.com/photo-1595777457583-95e059d581b8?w=500', base_price: 450, wholesale_price: null, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd8888888-8888-4888-a888-888888888888', name: 'قميص أكسفورد كلاسيك', description: 'قميص رجالي كلاسيك مناسب للعمل والمناسبات الرسمية.', section_id: '66666666-6666-4666-a666-666666666666', primary_image_url: 'https://images.unsplash.com/photo-1596755094514-f87e34085b2c?w=500', base_price: 380, wholesale_price: 300, is_active: true, created_at: new Date().toISOString(), deleted_at: null },
  { id: 'd9999999-9999-4999-a999-999999999999', name: 'حذاء كاجوال خفيف', description: 'حذاء رجالي مريح وخفيف الوزن للمشي اليومي.', section_id: '66666666-6666-4666-a666-666666666666', primary_image_url: 'https://images.unsplash.com/photo-1549298916-b41d501d3772?w=500', base_price: 420, wholesale_price: 330, is_active: true, created_at: new Date().toISOString(), deleted_at: null }
];
