...
- [ ] T023 [US2] Manually validate User Story 2 against `quickstart.md`'s "User Story 2" section, including the retail-mode isolation check (no showcase shown, no redirect, house hero unaffected) (depends on T021, T022)
